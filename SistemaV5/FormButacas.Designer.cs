namespace SistemaV5
{
    partial class FormButacas
    {
        ...
        private void InitializeComponent()
        {
            ...
            BtnConfirmarAsientos.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            BtnConfirmarAsientos.ForeColor = Color.White;
            BtnConfirmarAsientos.IconChar = FontAwesome.Sharp.IconChar.Chair;
            BtnConfirmarAsientos.IconColor = Color.White;
